...
- Relevance:`,
  ...
  engagingness: `You will be given a conversation between two individuals...`,
  groundedness: `You will be given a conversation and a knowledge snippet...`,
  naturalness: `You will be given a dialogue response...`,
};

export const GEVAL_SCORE_RANGES = {
  fluency: [1, 3],
  coherence: [1, 5],
  consistency: [1, 5],
  relevance: [1, 5],
